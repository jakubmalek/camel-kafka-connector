...
public class CamelAzureeventhubssourceSourceConnectorConfig
    ...
    public static final String CAMEL_SOURCE_AZUREEVENTHUBSSOURCE_KAMELET_CREDENTIAL_TYPE_CONF = "camel.kamelet.azure-eventhubs-source.credentialType";
    public static final String CAMEL_SOURCE_AZUREEVENTHUBSSOURCE_KAMELET_CREDENTIAL_TYPE_DOC = "Determines the credential strategy to adopt.";
    public static final String CAMEL_SOURCE_AZUREEVENTHUBSSOURCE_KAMELET_CREDENTIAL_TYPE_DEFAULT = "CONNECTION_STRING";
